            ...
            <div className="relative w-full max-w-md max-h-[90dvh] bg-[#131316] border border-white/10 rounded-2xl shadow-2xl overflow-hidden font-sans flex flex-col">
                ...
                <div className="p-5 flex flex-col gap-6 overflow-y-auto">
                    ...
                    <div>
                        ...
                        <div className={`border rounded-xl bg-white/5 p-3 flex justify-between items-center gap-2 transition-all ${isExceedingSafe ? 'border-indigo-500/50 bg-indigo-500/5' : 'border-white/10 focus-within:border-indigo-500/50 focus-within:bg-white/10'}`}>
                            ...
                            <div className="text-right flex flex-col items-end flex-1 min-w-0">
                                <input
                                    ...
                                    className={`w-full min-w-0 text-right bg-transparent text-xl font-bold focus:outline-none placeholder:text-zinc-600 ${isExceedingSafe ? 'text-indigo-400' : 'text-white'}`}
                                />
                        ...
                        <div className="border border-white/5 rounded-xl p-2 bg-black/20 flex flex-col gap-2">
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-2">
                                <div className="flex items-center gap-3 min-w-0">
                                    ...
                                    <ArrowUpToLine size={16} className={`shrink-0 transform ${isSuccess ? 'text-emerald-400' : 'text-zinc-400'}`} />
                                ...
                                <button
                                    ...
                                    className={`w-full sm:w-auto shrink-0 px-4 py-2.5 sm:py-1.5 rounded-lg text-sm font-medium transition-colors ${isSuccess
