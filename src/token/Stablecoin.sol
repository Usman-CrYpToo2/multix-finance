...
contract Stablecoin is IStablecoin, ERC20, Ownable {
    ...
    constructor(address _owner, address _protocol, string memory country, string memory currency)
        ERC20(string.concat("Stable_", country), string.concat("ST_", currency))
        Ownable(_owner)
    {
